...
import { Server, ShieldCheck, AlertCircle, Sparkles, Lock, Mail, Eye, EyeOff } from 'lucide-react';
...
export default function Login(props: LoginProps) {
  ...
  return (
    <div id="login_container" className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 font-sans">
      ...
      >
        <div id="login_brand_logo" className="flex items-center justify-center space-x-2.5">
          <div id="brand_icon_bg" className="h-12 w-12 rounded-xl bg-black border border-amber-500/30 flex items-center justify-center overflow-hidden shadow-lg shadow-amber-500/25 shrink-0">
            <img 
